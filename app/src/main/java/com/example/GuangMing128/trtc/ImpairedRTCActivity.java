...
public class ImpairedRTCActivity extends AppCompatActivity implements View.OnClickListener{

    private static final String TAG = "ImpairedRTCActivity";
    ...
    private void initView() {
        ...
        if (!TextUtils.isEmpty(mRoomId)) {
            mTitleText.setText(mRoomId);//标题设置为roomid
        }
    ...
    private void enterRoom() {
        ...
        mTRTCCloud.setListener(new ImpairedRTCActivity.TRTCCloudImplListener(ImpairedRTCActivity.this));
...
//        trtcParams.roomId = 128128128;
    ...
    private boolean checkPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (permissions.size() != 0) {
                ActivityCompat.requestPermissions(ImpairedRTCActivity.this,
    ...
    private class TRTCCloudImplListener extends TRTCCloudListener {
        ...
        private WeakReference<ImpairedRTCActivity> mContext;

        public TRTCCloudImplListener(ImpairedRTCActivity activity) {
            super();
        ...
        public void onError(int errCode, String errMsg, Bundle extraInfo) {
            ...
            ImpairedRTCActivity activity = mContext.get();
            if (activity != null) {
